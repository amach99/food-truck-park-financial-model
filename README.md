...
Financial feasibility model for a food truck park with a limited bar
(prepackaged beer + liquor shots in sealed plastic shot glasses — no
cocktails) at 13901 FM 812, Del Valle, TX. ~$75,000 startup cost, financed
via a personal line of credit at 12.5% interest.
...
10 tabs: Dashboard, Annual Projection, Sensitivity, Break-Even, Monte Carlo,
Scenarios, Multi-Year (including an LOC payoff schedule), Waterfall, Owner
Summary, and a Model Overview walkthrough.
